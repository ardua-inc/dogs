...
class MySQLDatabase(DatabaseInterface):
    ...
    def connect(self):
        ...
        conn.cursor().execute('SET SESSION sql_mode = "NO_ENGINE_SUBSTITUTION,STRICT_TRANS_TABLES"')
        return conn
    ...
    def init_db(self):
        ...
        cursor.execute('INSERT IGNORE INTO users (username, password_hash, role, full_name, email, is_active) VALUES (%s, %s, %s, %s, %s, %s)',
